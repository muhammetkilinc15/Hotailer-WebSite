...
namespace HotelProject.WebUI.Controllers
{
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:39280/api/Staff");
        ...
        [HttpPost]
        public async Task<IActionResult> AddStaff(AddStaffViewModel p)
        {
            var client = httpClientFactory.CreateClient();
        ...
        {
            var client = httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:39280/api/Staff/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
